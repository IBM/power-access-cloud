          ...
          >
            {({
              ...
              return (
                ...
                <h4> My group
                  <Tooltip align="bottom-left" size="lg" label="Groups control resource allocation by assigning the maximum Cores and memory available to you. By default, all new users are added to the Bronze group which includes .5 Cores and 8 GB of memory. If you require more CPU and memory, you can upgrade your group with a valid use case. You can only be a member of one group at a time.">
